...
class MoedasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create moeda" do
    assert_difference('Moeda.count') do
      post moedas_url, params: { moeda: { nome: @moeda.nome, sigla: @moeda.sigla, url_imagem: @moeda.url_imagem } }
    end
  ...
  test "should update moeda" do
    patch moeda_url(@moeda), params: { moeda: { nome: @moeda.nome, sigla: @moeda.sigla, url_imagem: @moeda.url_imagem } }
